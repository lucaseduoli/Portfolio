    ...
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-10">
        ...
        <img
                                    ...
                                    alt=""
                                />
          <p className="w-full text-left text-gray-400 mt-10 font-semibold">
          React | TypeScript | JS | GraphQL | Flutter | Dart | Docker | Github
          </p>
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-left text-white sm:text-6xl">
            Welcome to my portfolio.
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300 text-left">
          As an experienced developer, I am passionate about creating responsive, user-friendly, and visually engaging applications that meet the needs of modern users. <br></br> Here you will find examples of my front-end and mobile development projects, demonstrating my proficiency in utilizing these technologies to deliver seamless and efficient solutions.
          </p>
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="mailto:lucas.edu.oli@hotmail.com"
